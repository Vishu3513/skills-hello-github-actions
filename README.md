...
The shell script in the workflow will run whenever a new pull request is opened. test
...
1. In the **Pull requests** tab, create a pull request that will merge `test-workflow` into `main`. :smile:
1. Watch the workflow running in the checks section of the pull request.
1. Notice the comment that the workflow adds to the pull request.  test
...
&copy; 2023 GitHub &bull; [Code of Conduct](https://www.contributor-covenant.org/version/2/1/code_of_conduct/code_of_conduct.md) &bull; [MIT License](https://gh.io/mit)  test
